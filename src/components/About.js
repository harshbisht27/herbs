  ...
  return (
    <div className="about-container">
      <div className="about-box">
        <h1 className="about-heading">All About AyurSphere</h1>
        <p>
          AyurSphere is an Ayurvedic platform designed to promote the ancient wisdom of Ayurveda, especially among youth. Our mission is to make Ayurveda more accessible and relatable to the modern generation by blending traditional knowledge with contemporary lifestyles. At AyurSphere, you can explore the principles of Ayurveda, natural remedies, holistic healing, and yoga practices tailored to your individual health needs. Join us in a journey towards balanced living, healthy choices, and a better understanding of how Ayurveda can enhance your life.
        </p>
